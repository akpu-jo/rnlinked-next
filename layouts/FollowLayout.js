...
const FollowLayout = ({ children , ext}) => {
  ...
  return (
    <div>
      <AppBar alt={isMobile} showUser={!isMobile}></AppBar>
      <div className="max-w-6xl mx-auto sm:grid grid-cols-8 gap-5">
        <SideNav />
        <main className="col-span-4 xl:col-span-4 bg-slate-00 pb-20 mx-3">
          <div
